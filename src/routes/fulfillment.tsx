  ...
  return (
    <div className="fulfillment-page overflow-x-hidden bg-background text-foreground">
      ...
      <main>
        ...
        <section id="warehouse" className="scroll-mt-20 px-5 py-20 lg:px-0 lg:py-28"><div className="site-container"><div className="grid gap-10 lg:grid-cols-12"><div className="lg:col-span-5"><SectionLabel>Склад в Петербурге</SectionLabel><h2 className="text-4xl font-bold leading-none md:text-6xl">Приезжайте<br />и посмотрите</h2><p className="mt-6 max-w-md text-lg leading-relaxed text-muted-foreground">Покажем зоны приёмки, хранения и упаковки. Разберём ваши процессы на месте.</p><div className="mt-10 grid gap-5 border-t pt-6"><a href="tel:+78123293642" className="flex items-center gap-4 font-bold"><Phone className="text-primary" />+7 (812) 329-36-42</a><a href="mailto:info@tecos.spb.ru" className="flex items-center gap-4 font-bold"><Mail className="text-primary" />info@tecos.spb.ru</a><p className="flex items-start gap-4 font-bold"><MapPin className="shrink-0 text-primary" />Санкт-Петербург, пр. Юрия Гагарина, д. 1, оф. 306</p><p className="flex items-center gap-4 font-bold"><Clock className="text-primary" />Пн–Пт, 9:00–18:00</p></div><div className="mt-9 flex gap-3"><Button asChild variant="outline" size="icon" className="h-12 w-12 rounded-none shadow-none"><a href="https://wa.me/78123293642" aria-label="WhatsApp"><MessageCircle /></a></Button><Button asChild variant="outline" size="icon" className="h-12 w-12 rounded-none shadow-none"><a href="https://t.me/tecos" aria-label="Telegram"><Send /></a></Button></div></div><div className="min-h-[480px] overflow-hidden bg-secondary lg:col-span-7"><iframe title="Карта склада" src="https://yandex.ru/map-widget/v1/?ll=30.322%2C59.855&z=15&pt=30.322,59.855,pm2rdm" className="h-full min-h-[480px] w-full border-0 grayscale" loading="lazy" /></div></div></div></section>
