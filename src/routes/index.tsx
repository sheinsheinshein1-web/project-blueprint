...
function CinematicHero() {
  ...
  const slotStyles: Array<{ x: string; y: string; scale: number; blur: number; brightness: number; z: number; opacity: number }> = [
    ...
    { x: "22vw",   y: "0px",   scale: 0.78, blur: 2,  brightness: 1.06, z: 45, opacity: 0.88 },
    { x: "38vw",   y: "0px",   scale: 0.54, blur: 5,  brightness: 1.16, z: 40, opacity: 0.66 },
    { x: "54vw",   y: "0px",   scale: 0.34, blur: 10, brightness: 1.30, z: 35, opacity: 0.40 },
    { x: "78vw",   y: "0px",   scale: 0.18, blur: 18, brightness: 1.50, z: 30, opacity: 0 },
    { x: "-78vw",  y: "0px",   scale: 0.18, blur: 18, brightness: 1.50, z: 30, opacity: 0 },
    { x: "-54vw",  y: "0px",   scale: 0.34, blur: 10, brightness: 1.30, z: 35, opacity: 0.40 },
    { x: "-22vw",  y: "0px",   scale: 0.78, blur: 2,  brightness: 1.06, z: 45, opacity: 0.88 },
  ];
