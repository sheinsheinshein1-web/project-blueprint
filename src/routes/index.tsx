        ...
        <div className="relative">
          ...
          >
            {reviews.map((r, idx) => (
              <div
                key={r.name}
                className="w-[calc(72%-8px)] shrink-0 snap-start overflow-hidden rounded-[1.5rem] bg-white shadow-[0_12px_30px_rgba(20,24,40,0.06)] sm:w-[calc(50%-10px)] lg:w-[calc(33.333%-16px)] xl:w-[calc(20%-19.2px)]"
              >
